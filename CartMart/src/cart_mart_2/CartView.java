...
public class CartView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        welcomLabel.setText("Your Current Cart Contents");
        navPanel.add(welcomLabel);
        welcomLabel.setBounds(110, 0, 320, 33);

        checkOutButton.setFont(new java.awt.Font("Franklin Gothic Demi", 0, 18)); // NOI18N
        ...
        checkOutButton.setBounds(440, 60, 150, 27);
        ...
        cartButton1.setFont(new java.awt.Font("Franklin Gothic Demi", 0, 18)); // NOI18N
        cartButton1.setText("Return to Shop");
        cartButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cartButton1ActionPerformed(evt);
            }
        });
        navPanel.add(cartButton1);
        cartButton1.setBounds(420, 30, 170, 27);
